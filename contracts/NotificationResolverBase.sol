...
// This is only an example of a SchemaResolver. We can't implement
// Push Protocol smart contract notification at the moment beacuse
// they haven't a Commutator on Base

contract NotificationResolverBase is SchemaResolver {
    ...
    //    IPUSHCommInterface(PUSH_COMMUTATOR_ADDRESS).sendNotification(
